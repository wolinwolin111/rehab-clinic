#!/usr/bin/env python3
"""导入Excel预约表 - 正确解析：预约列=姓名 备注列第一行=项目 第二行=金额"""
...
TS = ['8:00-9:00','9:00-10:00','10:00-11:00','11:00-12:00','12:00-13:00','13:00-14:00','14:00-15:00','15:00-16:00','16:00-17:00','17:00-18:00','18:00-19:00','19:00-20:00','20:00-21:00','21:00-22:00']
...
for fname in sorted(os.listdir(EXCEL_DIR)):
    ...
    print(f'{fname} month={month} sheets={len(wb.sheetnames)}')
...
print(f'Projects: {known_projects}')
